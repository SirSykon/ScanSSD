...
WEIGHTS_PATH = "./AMATH512_e1GTDB.pth"
IMG_PATH = "../count_formulas/output/pdf_images/test/pdf_img_0.png"
OUTPUT_PATH = "../count_formulas/output/test.png"


md = MathDetector(WEIGHTS_PATH, ArgStub())
a = get_img(IMG_PATH)
